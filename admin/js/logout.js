/* ===================================================================
   Logout — confirmation modal UI/UX
   Replaces the native confirm() dialog with a styled, accessible
   modal that matches the admin portal's design system.
   =================================================================== */
    ...
    function buildOverlay() {
        ...
        el.innerHTML =
            '<div class="logout-card">' +
                ...
                '<p id="logoutDesc">You\u2019ll need to sign in again to access the admin portal.</p>' +
